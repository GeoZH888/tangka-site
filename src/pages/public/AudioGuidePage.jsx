...
export default function AudioGuidePage() {
  ...
  function play() {
    ...
    const audioUrl = work[`audio_${lang}_url`];
  ...
  function speakFallback() {
    ...
    const intro = lang === 'zh'
      ? `${title}。${work.year_created}年作品。${t(work, 'materials')}。尺寸 ${work.dimensions}。${desc}`
      : lang === 'it'
        ? `${title}. Anno ${work.year_created}. ${t(work, 'materials')}. Dimensioni ${work.dimensions}. ${desc}`
        : `${title}. From ${work.year_created}. ${t(work, 'materials')}. Dimensions ${work.dimensions}. ${desc}`;
    ...
    <div className="ag-page" style={{ '--ag-bg': pigmentGradient(colorTheme) }}>
      ...
      <div className="ag-body">
        ...
        <div className="ag-meta">
          <div className="ag-year">{work.year_created}</div>
